...
## Project Structure
    ...
    ├── testapiautoconnect_124899  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_124899`
...
2. Clone this repo and `cd testapiautoconnect_124899`
